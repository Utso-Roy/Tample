...
const Stats = () => {
  ...
  useEffect(() => {
    fetch("https://tample-server.vercel.app/totalAddIncome")
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    fetch("https://tample-server.vercel.app/totalExpenseIncome")
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 px-4">
      <div className="mb-6 text-center">
        <h2 className="text-2xl font-bold text-orange-700  dark:text-white mb-2">
          সারাংশ (Overview)
        </h2>
      </div>
