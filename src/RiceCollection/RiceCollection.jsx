...
const API_URL = "https://tample-server.vercel.app/rice-collections";
...
const RiceCollection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: `${savedData.kg.toFixed(2)} কেজি চাল ${
          savedData.name
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      Swal.fire(
        "মুছে ফেলা হয়েছে!",
        "চালটি সফলভাবে মুছে ফেলা হয়েছে।",
        "success"
      );
    } catch (error) {
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 text-gray-800 dark:text-gray-200">
      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-600 rounded-xl p-6">
        ...
        <div className="text-right mt-6 text-lg font-semibold text-[#14532d] dark:text-green-400">
          মোট চাল:{" "}
          <span className="text-xl font-bold">{totalKg?.toFixed(2)} কেজি</span>
        </div>
      </div>
              ...
              <tbody>
                ...
                {dataList.map((item) => (
                  <tr
                    ...
                    className="hover:bg-[#d1fae5] dark:hover:bg-gray-800"
                  >
                    <td className="px-4 py-2 text-[#14532d] dark:text-green-300">
                      {item.date}
                    </td>
                    <td className="px-4 py-2 text-[#14532d] dark:text-green-300">
                      {item.name}
